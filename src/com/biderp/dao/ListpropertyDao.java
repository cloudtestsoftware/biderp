	...
	public class ListpropertyDao extends ListpropertyImpl {
		...
		protected String [] maindatadomain={"Int_t","Int_t","Int_t","Name_t","Name_t","String50_t","String50_t","String100_t","Int_t"};
	...
	protected String [] propListpropertylist={};
		...
		public Rows getListpropertySummaryRows(){
			TemplateTable tab=this.doSelect(summarycol,summarysqldatatype,this.ListpropertyFilter);
		...
		public Rows getListpropertyRows(){
			...
			Rows rows=tu.getXMLRows(tab, "Listproperty",codeListpropertylist,propListpropertylist,relationListpropertylist,maincolcaption,maindatadomain,this.getGroupuser(),bqn);
			ArrayList<Userdata> userdata=rows.getUserdata();
		...
		public Rows getListpropertyRowModified(){
			Rows rows=tu.getXMLRows(maindata, "Listproperty",codeListpropertylist,propListpropertylist,relationListpropertylist,maincolcaption,maindatadomain,this.getGroupuser(),bqn);
			return rows;
		}
		...
		public void postListpropertyContainer() throws DaoException{
		...
		public Rows getListpropertyByFilter(){
			...
			Rows rows=tu.getXMLFilterRows(tab, "Listproperty",codeListpropertylist,propListpropertylist,relationListpropertylist,maincol,maincolcaption,maindatadomain,this.getGroupuser(),bqn);
			ArrayList<Userdata> userdata=rows.getUserdata();
			Userdata data1= new Userdata("tabs",Arrays.asList(childtabs));
			Userdata data2= new Userdata("tabnames",Arrays.asList(childtabnames));
			Userdata data3= new Userdata("filters",Arrays.asList(maincolsearch));
