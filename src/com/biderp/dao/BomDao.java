	...
	public class BomDao extends BomImpl {
		...
		protected String [] maindatadomain={"Int_t","Name_t","String30_t","Name_t","String100_t","Code_t","Code_t","String20_t","Int_t","Int_t","Int_t","Int_t","Int_t","Int_t"};
		...
		protected String [] reportdatadomain={"Id_t","Name_t","String30_t","Name_t","String100_t","Code_t","Code_t","String20_t","Int_t","Int_t","Int_t","Int_t"};
		...
		protected String [] searchdatadomain={"Id_t","Name_t","String30_t","Name_t","String100_t","Code_t","Code_t","String20_t"};

	protected String [] propBomlist={};
		protected String [] codeBomlist={"umcode","deptcode"};
		protected String [] relationBomlist={};

		public BomDao(UriInfo uriInfo, HttpHeaders header) throws AuthenticationException{
			this.setObject("Bom");
		...
		public void setPostXml(String xml) throws DaoException{
			...
			for(String entity:entitys){
				String tmp="";
				if(entity.toLowerCase().contains("<bom>")){
					tmp=entity.replace("<?", "");
		...
		public Rows getBomSummaryRows(){
			TemplateTable tab=this.doSelect(summarycol,summarysqldatatype,this.BomFilter);
			ArrayList<String> chartcols=tu.getChartSelectColumns("Bom");
			...
			for(String chartcol:chartcols){
				ArrayList<String> datas= tu.getChartPropertyJSON("Bom", tab, chartcol);
		...
		public Rows getBomRows(){
			TemplateTable tab=this.doSelect(maincol,mainsqldatatype,null);
			Rows rows=tu.getXMLRows(tab, "Bom",codeBomlist,propBomlist,relationBomlist,maincolcaption,maindatadomain,this.getGroupuser(),bqn);
			ArrayList<Userdata> userdata=rows.getUserdata();
		...
		public Rows getBomRowModified(){
			Rows rows=tu.getXMLRows(maindata, "Bom",codeBomlist,propBomlist,relationBomlist,maincolcaption,maindatadomain,this.getGroupuser(),bqn);
			return rows;
		}

		public Rows getBomRowDeleted(){
			Rows rows;
		...
		public void postBomContainer() throws DaoException{
		...
		public Rows getBomByFilter(){
			String newfilter=" groupuser='"+this.getGroupuser()+"'";
			if(!tu.isEmptyValue(this.getFilters())){
				newfilter+=" and bom2"+this.getFilters();
			}
			String sql= "select * from table_Bom where "+ newfilter;
			TemplateTable tab=tu.getResultSet(sql);
			Rows rows=tu.getXMLFilterRows(tab, "Bom",codeBomlist,propBomlist,relationBomlist,maincol,maincolcaption,maindatadomain,this.getGroupuser(),bqn);
			ArrayList<Userdata> userdata=rows.getUserdata();
			Userdata data1= new Userdata("tabs",Arrays.asList(childtabs));
			Userdata data2= new Userdata("tabnames",Arrays.asList(childtabnames));
			Userdata data3= new Userdata("filters",Arrays.asList(maincolsearch));
