	...
	public class EmaildocsDao extends EmaildocsImpl {
		...
		protected String [] maindatadomain={"Int_t","Int_t","Int_t","String200_t","String300_t","String500_t"};
	...
	protected String [] propEmaildocslist={};
		...
		public Rows getEmaildocsSummaryRows(){
			TemplateTable tab=this.doSelect(summarycol,summarysqldatatype,this.EmaildocsFilter);
		...
		public Rows getEmaildocsRows(){
			...
			Rows rows=tu.getXMLRows(tab, "Emaildocs",codeEmaildocslist,propEmaildocslist,relationEmaildocslist,maincolcaption,maindatadomain,this.getGroupuser(),bqn);
			ArrayList<Userdata> userdata=rows.getUserdata();
		...
		public Rows getEmaildocsRowModified(){
			Rows rows=tu.getXMLRows(maindata, "Emaildocs",codeEmaildocslist,propEmaildocslist,relationEmaildocslist,maincolcaption,maindatadomain,this.getGroupuser(),bqn);
			return rows;
		}
		...
		public void postEmaildocsContainer() throws DaoException{
		...
		public Rows getEmaildocsByFilter(){
			...
			Rows rows=tu.getXMLFilterRows(tab, "Emaildocs",codeEmaildocslist,propEmaildocslist,relationEmaildocslist,maincol,maincolcaption,maindatadomain,this.getGroupuser(),bqn);
			ArrayList<Userdata> userdata=rows.getUserdata();
			Userdata data1= new Userdata("tabs",Arrays.asList(childtabs));
			Userdata data2= new Userdata("tabnames",Arrays.asList(childtabnames));
			Userdata data3= new Userdata("filters",Arrays.asList(maincolsearch));
