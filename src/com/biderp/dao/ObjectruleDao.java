	...
	public class ObjectruleDao extends ObjectruleImpl {
		...
		protected String [] maindatadomain={"Int_t","Int_t","Name_t","Name_t","Name_t","String4000_t","Type_t","Type_t","String500_t","Int_t","Status_t"};
	...
	protected String [] propObjectrulelist={"reason","actionstate","status"};
		...
		protected String [] actionquerycol={"objid","name","stepno","input","inputdatatype","output","querytype","hasrecordset","status"};
		protected String [] actionquerycolcaption={"Id","Action Name","StepNo","Input(@param)","Input Datatype(@type)","Output($param)","Query Type","Has Recordset","Status"};
		protected String [] actionquerysqldatatype={DataType.VARCHAR,DataType.VARCHAR,DataType.INTEGER,DataType.VARCHAR,DataType.VARCHAR,DataType.VARCHAR,DataType.VARCHAR,DataType.VARCHAR,DataType.VARCHAR};
		protected String [] actionquerydatadomain={"Int_t","Name_t","Int_t","String2000_t","String500_t","String2000_t","Type_t","Boolean_t","Status_t"};
		protected String [] actionquerydisable={"yes,no,no,no,no,no,no,no,no"};
		protected String [] actionquerycolsearch={"#text_filter,#text_filter,#text_filter,,,,#select_filter,#select_filter,#text_filter"};
		...
		public Rows getActionqueryRows(){
			TemplateTable tab=this.doSelectChild("actionquery", "actionquery2objectrule",this.getParentobjid(),actionquerycol,actionquerysqldatatype,this.ActionqueryFilter);
			String [] propActionquerylist={"querytype","hasrecordset","status"};
			String [] codeActionquerylist={};
			String [] relationActionquerylist={};
			Rows rows=tu.getXMLRows(tab, "actionquery",codeActionquerylist,propActionquerylist,relationActionquerylist,actionquerycolcaption,actionquerydatadomain,this.getGroupuser(),bqn);
		...
		public Rows getObjectruleSummaryRows(){
			TemplateTable tab=this.doSelect(summarycol,summarysqldatatype,this.ObjectruleFilter);
		...
		public Rows getObjectruleRows(){
			...
			Rows rows=tu.getXMLRows(tab, "Objectrule",codeObjectrulelist,propObjectrulelist,relationObjectrulelist,maincolcaption,maindatadomain,this.getGroupuser(),bqn);
			ArrayList<Userdata> userdata=rows.getUserdata();
		...
		public Rows getObjectruleRowModified(){
			Rows rows=tu.getXMLRows(maindata, "Objectrule",codeObjectrulelist,propObjectrulelist,relationObjectrulelist,maincolcaption,maindatadomain,this.getGroupuser(),bqn);
			return rows;
		}
		...
		public Rows getObjectruleByFilter(){
			...
			Rows rows=tu.getXMLFilterRows(tab, "Objectrule",codeObjectrulelist,propObjectrulelist,relationObjectrulelist,maincol,maincolcaption,maindatadomain,this.getGroupuser(),bqn);
			ArrayList<Userdata> userdata=rows.getUserdata();
			Userdata data1= new Userdata("tabs",Arrays.asList(childtabs));
			Userdata data2= new Userdata("tabnames",Arrays.asList(childtabnames));
			Userdata data3= new Userdata("filters",Arrays.asList(maincolsearch));
