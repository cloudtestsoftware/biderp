	...
	public class MysubscriptionDao extends MysubscriptionImpl {
		...
		protected String [] maindatadomain={"Int_t","Email_t","Code_t","Date_t","Date_t"};
	...
	protected String [] propMysubscriptionlist={};
		...
		public Rows getMysubscriptionSummaryRows(){
			TemplateTable tab=this.doSelect(summarycol,summarysqldatatype,this.MysubscriptionFilter);
		...
		public Rows getMysubscriptionRows(){
			...
			Rows rows=tu.getXMLRows(tab, "Mysubscription",codeMysubscriptionlist,propMysubscriptionlist,relationMysubscriptionlist,maincolcaption,maindatadomain,this.getGroupuser(),bqn);
			ArrayList<Userdata> userdata=rows.getUserdata();
		...
		public Rows getMysubscriptionRowModified(){
			Rows rows=tu.getXMLRows(maindata, "Mysubscription",codeMysubscriptionlist,propMysubscriptionlist,relationMysubscriptionlist,maincolcaption,maindatadomain,this.getGroupuser(),bqn);
			return rows;
		}
		...
		public void postMysubscriptionContainer() throws DaoException{
		...
		public Rows getMysubscriptionByFilter(){
			...
			Rows rows=tu.getXMLFilterRows(tab, "Mysubscription",codeMysubscriptionlist,propMysubscriptionlist,relationMysubscriptionlist,maincol,maincolcaption,maindatadomain,this.getGroupuser(),bqn);
			ArrayList<Userdata> userdata=rows.getUserdata();
			Userdata data1= new Userdata("tabs",Arrays.asList(childtabs));
			Userdata data2= new Userdata("tabnames",Arrays.asList(childtabnames));
			Userdata data3= new Userdata("filters",Arrays.asList(maincolsearch));
