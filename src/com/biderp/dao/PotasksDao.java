	...
	protected String [] propPotaskslist={"stage"};
		...
		public Rows getPotasksSummaryRows(){
			TemplateTable tab=this.doSelect(summarycol,summarysqldatatype,this.PotasksFilter);
		...
		public Rows getPotasksRows(){
			...
			Rows rows=tu.getXMLRows(tab, "Potasks",codePotaskslist,propPotaskslist,relationPotaskslist,maincolcaption,maindatadomain,this.getGroupuser(),bqn);
			ArrayList<Userdata> userdata=rows.getUserdata();
		...
		public Rows getPotasksRowModified(){
			Rows rows=tu.getXMLRows(maindata, "Potasks",codePotaskslist,propPotaskslist,relationPotaskslist,maincolcaption,maindatadomain,this.getGroupuser(),bqn);
			return rows;
		}
		...
		public void postPotasksContainer() throws DaoException{
		...
		public Rows getPotasksByFilter(){
			...
			Rows rows=tu.getXMLFilterRows(tab, "Potasks",codePotaskslist,propPotaskslist,relationPotaskslist,maincol,maincolcaption,maindatadomain,this.getGroupuser(),bqn);
			ArrayList<Userdata> userdata=rows.getUserdata();
			Userdata data1= new Userdata("tabs",Arrays.asList(childtabs));
			Userdata data2= new Userdata("tabnames",Arrays.asList(childtabnames));
			Userdata data3= new Userdata("filters",Arrays.asList(maincolsearch));
