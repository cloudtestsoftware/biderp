	 ...
	 * @author S.K Jana Version 1.0 
	 ...
	 public class QrinfoImpl implements QueryEvent {
		...
		public  boolean  doInsert(){
			...
			if(!tu.isEmptyValue(this.getMainxml())){
					sql=query.makeBulkSQL(true,this.getMainxml(),"QRInfo2PartPrice",this.getUsername(),this.getGroupuser());
			...
			if(sql==null){
				...
				setParentobjid(query.getObjId()); 
				 if(!tu.isEmptyValue(this.getItemspecxml()) ){
					 sql+=query.makeBulkSQL(false,getItemspecxml(),"ItemSpec2QRInfo",this.getUsername(),this.getGroupuser());
