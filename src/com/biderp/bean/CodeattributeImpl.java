	 ...
	 * @author S.K Jana Version 1.0 
	 ...
	 public class CodeattributeImpl implements QueryEvent {
			...
			if(sql==null){
				...
				setParentobjid(query.getObjId()); 
				 if(!tu.isEmptyValue(this.getCustomcodexml()) ){
					 sql+=query.makeBulkSQL(false,getCustomcodexml(),"CustomCode2CodeAttribute",this.getUsername(),this.getGroupuser());
