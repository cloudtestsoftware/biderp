	 ...
	 * @author S.K Jana Version 1.0 
	 ...
	 public class SupplierImpl implements QueryEvent {
			...
			if(sql==null){
				...
				setParentobjid(query.getObjId()); 
				 if(!tu.isEmptyValue(this.getBizprofilexml()) ){
					 sql+=query.makeBulkSQL(false,getBizprofilexml(),"BizProfile2Supplier",this.getUsername(),this.getGroupuser());
				 ...
				 if(!tu.isEmptyValue(this.getContactxml()) ){
					 sql+=query.makeBulkSQL(false,getContactxml(),"Contact2Supplier",this.getUsername(),this.getGroupuser());
				 ...
				 usql+="\n\t\t"+tu.copyParentBQN2Child(this.getObject(),"Contact","Contact2Supplier",getParentobjid());
				}
				 if(!tu.isEmptyValue(this.getJobhistoryxml()) ){
					 sql+=query.makeBulkSQL(false,getJobhistoryxml(),"JobHistory2Supplier",this.getUsername(),this.getGroupuser());
				 ...
				 if(!tu.isEmptyValue(this.getUserxml()) ){
					 sql+=query.makeBulkSQL(false,getUserxml(),"User2Supplier",this.getUsername(),this.getGroupuser());
			...
			if(ACONST.GENERATE_LOG)
			 ...
			 if (query.getTableResultset().getRowCount()>0){
				...
				if(ACONST.GENERATE_LOG)
				 ...
				 tu.applyMTMRelation("contact","Supplier",getParentobjid());
