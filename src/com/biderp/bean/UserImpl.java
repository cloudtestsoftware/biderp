	 ...
	 * @author S.K Jana Version 1.0 
	 ...
	 public class UserImpl implements QueryEvent {
		...
		public  boolean  doInsert(){
			...
			if(!tu.isEmptyValue(this.getMainxml())){
					sql=query.makeBulkSQL(true,this.getMainxml(),"User2PrivilegeGroup",this.getUsername(),this.getGroupuser());
			...
			if(sql==null){
				...
				setParentobjid(query.getObjId()); 
				 if(!tu.isEmptyValue(this.getMessagequeuexml()) ){
					 sql+=query.makeBulkSQL(false,getMessagequeuexml(),"MessageQueue2User",this.getUsername(),this.getGroupuser());
