	 ...
	 * @author S.K Jana Version 1.0 
	 ...
	 public class ListpropertyImpl implements QueryEvent {
		...
		public  boolean  doInsert(){
			...
			if(!tu.isEmptyValue(this.getMainxml())){
					sql=query.makeBulkSQL(true,this.getMainxml(),"ListProperty2Attribute",this.getUsername(),this.getGroupuser());
