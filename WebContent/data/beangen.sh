...
#java -classpath $JAVA_CLASSPATH cms.service.gen.beangen -bean BizProfile -beanpath $JSP_HOME/src  -app biderp -inifile $DATA_PATH/context.xml
#java -classpath $JAVA_CLASSPATH cms.service.gen.beangen -bean BizDomain -beanpath $JSP_HOME/src  -app biderp -inifile $DATA_PATH/context.xml
#java -classpath $JAVA_CLASSPATH cms.service.gen.beangen -bean Supplier -beanpath $JSP_HOME/src  -app biderp -inifile $DATA_PATH/context.xml
java -classpath $JAVA_CLASSPATH cms.service.gen.beangen -bean RFQ -beanpath $JSP_HOME/src  -app biderp -inifile $DATA_PATH/context.xml
java -classpath $JAVA_CLASSPATH cms.service.gen.beangen -bean RFQEmail -beanpath $JSP_HOME/src  -app biderp -inifile $DATA_PATH/context.xml
#java -classpath $JAVA_CLASSPATH cms.service.gen.beangen -bean EmailDocs -beanpath $JSP_HOME/src  -app biderp -inifile $DATA_PATH/context.xml
