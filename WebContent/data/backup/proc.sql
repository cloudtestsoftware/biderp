...
CREATE PROCEDURE     INSERT_ADDUSER (pnObjid raw) IS
...
CREATE PROCEDURE     INSERT_BIDPROJECT (pnObjid raw) IS
...
CREATE PROCEDURE INSERT_BIDREQUEST (pnObjid raw) IS 
...
CREATE PROCEDURE     INSERT_BIDWON (BidReqId raw,ProjectId raw,VendBidNo raw,guser varchar,grpuser varchar) IS
...
CREATE PROCEDURE     INSERT_BUDGET (pnObjid raw) IS
...
CREATE PROCEDURE     INSERT_CALENDAR (pnObjid raw) IS
...
CREATE PROCEDURE INSERT_INVITATION (pnObjid raw) IS 
...
CREATE PROCEDURE     INSERT_MILESTONE (pnObjid raw) IS
...
CREATE PROCEDURE     INSERT_PARTPRICE (pnObjid raw) IS
...
CREATE PROCEDURE     INSERT_PARTS (pnObjid raw) IS
...
CREATE PROCEDURE     INSERT_PROFILE (pnObjid raw) IS
...
CREATE PROCEDURE     INSERT_PROJECT (pnObjid raw) IS
...
CREATE PROCEDURE     INSERT_PROJECTLEAD (bidReqId raw,VendorbidId raw,vuser varchar,vgroupuser varchar) IS
...
CREATE PROCEDURE     INSERT_QUOTE (pnObjid raw) IS
...
CREATE PROCEDURE     INSERT_USER (pnObjid raw) IS
...
CREATE PROCEDURE INSERT_VENDORBID (pnObjid raw) IS 
--Constants for status
STATUS_OPEN	varchar2(20):='1';
STATUS_INVITED	varchar2(20):='INVITED';
...
CREATE PROCEDURE     UPDATE_BIDPROJECT (pnObjid raw) IS
...
CREATE PROCEDURE     UPDATE_BIDREQUEST (pnObjid raw) IS
...
CREATE PROCEDURE     UPDATE_BIDWON (vendorBidNo raw,projectno raw) IS
...
CREATE PROCEDURE     UPDATE_BOQPLAN (pnObjid raw) IS
...
CREATE PROCEDURE     UPDATE_FINANCIALTERM (pnObjid raw) IS
...
CREATE PROCEDURE     UPDATE_ITEMDISPATCH (pnObjid raw) IS
...
CREATE PROCEDURE     UPDATE_ITEMRECEIVED (pnObjid raw) IS
...
CREATE PROCEDURE     UPDATE_JOBLIST (pnObjid raw) IS
...
CREATE PROCEDURE     UPDATE_MAINCODE (pnObjid raw) IS
...
CREATE PROCEDURE     UPDATE_PARTS (pnObjid raw) IS
...
CREATE PROCEDURE     UPDATE_POINVOICE (pnObjid raw) IS
...
CREATE PROCEDURE     UPDATE_PROFILE (pnObjid raw) IS
...
CREATE PROCEDURE     UPDATE_PROJECT (pnObjid raw) IS
...
CREATE PROCEDURE     UPDATE_PROJECTCODE (pnObjid raw) IS
...
CREATE PROCEDURE     UPDATE_PURCHASEORDER (pnObjid raw) IS
...
CREATE PROCEDURE     UPDATE_QUOTE (pnObjid raw) IS
...
CREATE PROCEDURE     UPDATE_QUOTEJOBS (pnObjid Number) IS
...
CREATE PROCEDURE     UPDATE_RESOURCEORDER (pnObjid raw) IS
...
CREATE PROCEDURE     UPDATE_SUBCODE (pnObjid raw) IS
...
CREATE PROCEDURE     UPDATE_TASKCODE (pnObjid raw) IS
...
CREATE PROCEDURE     UPDATE_TASKRESOURCE (pnObjid raw) IS
...
CREATE PROCEDURE     UPDATE_VENDORBID (pnObjid raw) IS
...
CREATE PROCEDURE     UPDATE_WHATTODO (pnObjid raw) is
