--------------------------------------------------------
--  File created - Wednesday-February-05-2014   
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Procedure INSERT_ADDUSER
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "INSERT_ADDUSER" (pnObjid NUMBER) IS
...
/
--------------------------------------------------------
--  DDL for Procedure INSERT_BIDPROJECT
--------------------------------------------------------
set define off;
...
Begin
		...
		select min(objid) into bidreqid from table_bidrequest where objid<0;
...
Begin
		...
		select min(objid) into generalid from table_general where objid<0;
...
Begin
		...
		select min(objid) into contactid from table_contact where objid<0;
...
Begin
		...
		select min(objid) into jobid from table_jobs where objid<0;
...
Begin
	...
	LOOP
	bidreqid := nvl(bidreqid,0)-1;
	generalid:=nvl(generalid,0)-1;
	contactid:=nvl(contactid,0)-1;
	jobid:=nvl(jobid,0)-1;
...
/
--------------------------------------------------------
--  DDL for Procedure INSERT_BIDREQUEST
--------------------------------------------------------
set define off;
...
/
--------------------------------------------------------
--  DDL for Procedure INSERT_BIDWON
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "INSERT_BIDWON" (BidReqId NUMBER,ProjectId Number,VendBidNo number,guser varchar,grpuser varchar) IS
...
/
--------------------------------------------------------
--  DDL for Procedure INSERT_BUDGET
--------------------------------------------------------
set define off;
...
/
--------------------------------------------------------
--  DDL for Procedure INSERT_CALENDAR
--------------------------------------------------------
set define off;
...
/
--------------------------------------------------------
--  DDL for Procedure INSERT_MILESTONE
--------------------------------------------------------
set define off;
...
begin
	...
	select min(objid) into id from table_BoqPlan where objid<0;
...
/
--------------------------------------------------------
--  DDL for Procedure INSERT_PARTPRICE
--------------------------------------------------------
set define off;
...
/
--------------------------------------------------------
--  DDL for Procedure INSERT_PARTS
--------------------------------------------------------
set define off;
...
/
--------------------------------------------------------
--  DDL for Procedure INSERT_PROFILE
--------------------------------------------------------
set define off;
...
--opening cursor m_User_cur
	id:=0;
Begin
		select decode(reasoncode,1,'Bidding',2,'Quote',3,'Bid Plus Own',4,'ERP No Bidding',5,'ERP With Bidding','Bidding')
...
Begin
		select objid into privid from table_privilegegroup where upper(name)=upper(privgroup);
...
/
--------------------------------------------------------
--  DDL for Procedure INSERT_PROJECT
--------------------------------------------------------
set define off;
...
/
--------------------------------------------------------
--  DDL for Procedure INSERT_PROJECTLEAD
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "INSERT_PROJECTLEAD" (bidReqId NUMBER,VendorbidId number,vuser varchar,vgroupuser varchar) IS
...
/
--------------------------------------------------------
--  DDL for Procedure INSERT_QUOTE
--------------------------------------------------------
set define off;
...
Begin
	...
	update table_user set groupuser=i_Profile_cur.groupuser where objid=pnObjid and user2supplier>0;
...
/
--------------------------------------------------------
--  DDL for Procedure UPDATE_BIDPROJECT
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "UPDATE_BIDPROJECT" (pnObjid NUMBER) IS
...
/
--------------------------------------------------------
--  DDL for Procedure UPDATE_BIDREQUEST
--------------------------------------------------------
set define off;
...
Begin
		...
		update table_partrequest p set
			 ...
			 p.status=STATUS_OPEN,p.originid=-1
...
/
--------------------------------------------------------
--  DDL for Procedure UPDATE_BIDWON
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "UPDATE_BIDWON" (vendorBidNo NUMBER,projectno Number) IS
...
/
--------------------------------------------------------
--  DDL for Procedure UPDATE_BOQPLAN
--------------------------------------------------------
set define off;
...
/
--------------------------------------------------------
--  DDL for Procedure UPDATE_FINANCIALTERM
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "UPDATE_FINANCIALTERM" (pnObjid NUMBER) IS
...
/
--------------------------------------------------------
--  DDL for Procedure UPDATE_ITEMDISPATCH
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "UPDATE_ITEMDISPATCH" (pnObjid NUMBER) IS

--Constants for status
STATUS_DISPATCHED	varchar2(20):='5';
qntrqst integer:=0;
qntdisp integer:=0;
partrequsetid integer:=0;
BEGIN
...
/
--------------------------------------------------------
--  DDL for Procedure UPDATE_ITEMRECEIVED
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "UPDATE_ITEMRECEIVED" (pnObjid NUMBER) IS
...
/
--------------------------------------------------------
--  DDL for Procedure UPDATE_JOBLIST
--------------------------------------------------------
set define off;
...
/
--------------------------------------------------------
--  DDL for Procedure UPDATE_MAINCODE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "UPDATE_MAINCODE" (pnObjid NUMBER) IS
...
/
--------------------------------------------------------
--  DDL for Procedure UPDATE_PARTS
--------------------------------------------------------
set define off;
...
/
--------------------------------------------------------
--  DDL for Procedure UPDATE_POINVOICE
--------------------------------------------------------
set define off;
...
WHERE
 ...
 AND j.objid = ms.originid
 AND ms.milestone2projectplan=0
 order by j.objid;
...
--update parts2boq
  Begin
    ...
    where p.parts2joblist=i_BOQUP_cur.joblistid and p.parts2boq=0;
  ...
  Begin
    ...
    where t.taskresource2joblist=i_BOQUP_cur.joblistid and t.taskresource2boq=0;
...
/
--------------------------------------------------------
--  DDL for Procedure UPDATE_PROJECTCODE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "UPDATE_PROJECTCODE" (pnObjid NUMBER) IS
...
/
--------------------------------------------------------
--  DDL for Procedure UPDATE_PURCHASEORDER
--------------------------------------------------------
set define off;
...
/
--------------------------------------------------------
--  DDL for Procedure UPDATE_QUOTE
--------------------------------------------------------
set define off;
...
mycount integer;
m_consoleid  integer;
quote2messagequeue integer;
qtstatus varchar2(20):=0;
projectid integer;
m_projconsoleid integer;
destid integer;
...
--First get consoleid and messagequeue id
	...
	Begin
		...
		if quote2messagequeue =0 and mycount=0 then
	...
	Begin
		...
		Update Table_Jobmaster
			...
			where  moduser='Quote' and jobmaster2project=0;

		Update Table_Joblist

		set Joblist2project=projectid

		where  moduser='Quote' and joblist2project=0;
		...
		where destinitionid=pnObjid and moduser='Quote' and Contact2project=0;
...
qm.projectcode=q.projectcode and qm.maincode=q.maincode ) where  q.quotejobs2quotemaster=0;
...
m.projectcode=j.projectcode and m.maincode=j.maincode and j.joblist2project=projectid) where  j.joblist2jobmaster=0;
...
m.projectcode=j.projectcode and m.maincode=j.maincode and p.subcode=j.subcode and j.joblist2project=projectid) where   p.parts2joblist=0;
...
(select j.objid from table_joblist j, table_jobmaster m where j.joblist2jobmaster=m.objid and  m.jobmaster2project=projectid and
m.projectcode=j.projectcode and m.maincode=j.maincode and j.subcode=r.subcode and j.joblist2project=projectid) where   r.taskresource2joblist=0;
...
/
--------------------------------------------------------
--  DDL for Procedure UPDATE_QUOTEJOBS
--------------------------------------------------------
set define off;
...
/
--------------------------------------------------------
--  DDL for Procedure UPDATE_RESOURCEORDER
--------------------------------------------------------
set define off;
...
/
--------------------------------------------------------
--  DDL for Procedure UPDATE_SUBCODE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "UPDATE_SUBCODE" (pnObjid NUMBER) IS
...
/
--------------------------------------------------------
--  DDL for Procedure UPDATE_TASKCODE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "UPDATE_TASKCODE" (pnObjid NUMBER) IS
...
/
--------------------------------------------------------
--  DDL for Procedure UPDATE_TASKRESOURCE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "UPDATE_TASKRESOURCE" (pnObjid NUMBER) IS
...
/
--------------------------------------------------------
--  DDL for Procedure UPDATE_VENDORBID
--------------------------------------------------------
set define off;
...
/
--------------------------------------------------------
--  DDL for Procedure UPDATE_WHATTODO
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "UPDATE_WHATTODO" (pnObjid integer) is
