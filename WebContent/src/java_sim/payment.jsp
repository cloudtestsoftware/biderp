...
<HTML lang='en'>
<HEAD>
	<TITLE>Artitelly Payment Processing </TITLE>
</HEAD>
<BODY>
...
String loginID			= "7S5cw8Ly";
String transactionKey	= "45e86B8rSENWCu9Q";
String amount			= "";
String description		= "Payment for training services";
String label 			= "Make Payment"; // The is the label on the 'submit' button
...
out.println ("<h3>Please click below button to process your payment.</h3> <br/>");
out.println ("<h4><font color=\"red\">Please DO NOT change your email ID which appears in payment page from your login.</font></h4> <br/><br/>");
out.println ("Amount: <b>" + amount + "</b> <br><br>");
...
out.println ("	<INPUT type='hidden' name='x_po_num' value='" +  ponumber + "' />");
out.println ("	<INPUT type='hidden' name='x_email' value='" + email + "' />");
out.println ("	<INPUT type='hidden' name='x_show_form' value='PAYMENT_FORM' />");
out.println ("  <br><br> ");
out.println ("	<input width='20' length='200' type='submit' value='" + label + "' />");
out.println ("</FORM>");
%>
